...
public class LineIntersect {
     ...
     */
    public static boolean linesIntersect(final float X1, final float Y1, final float X2, final float Y2,
     ...
     */
    private static int relativeCCW(final float X1, final float Y1, float X2, float Y2, float PX,
                                   float PY) {
        X2 -= X1;
        Y2 -= Y1;
        PX -= X1;
        PY -= Y1;
        int ccw = (int) (PX * Y2 - PY * X2);
        if (ccw == 0) {
